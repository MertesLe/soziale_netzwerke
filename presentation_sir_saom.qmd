...
## timing limits on diffusion {.custom-smaller}
...
-   Granovetter model: participation is interdependent but with varying levels of acceptable cost\
-   extended: local neighborhood threshold\
-   Valentes model: infer adoption thresholds from the data\
-   Centola and Macys: complex contagions
...
(Annahmen:?) Baseline Modell erweitern:
...
Causal Inference: selection-or-inﬂuence debate
...
input:\
coefficient, standard error, nr of observations , nr of covariates, nr of treatment condition cases
